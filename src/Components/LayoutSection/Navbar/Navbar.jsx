...
const serviceLinks = [
  ...
  // Coffee Table Books – with nested children
  { 
    ...
    children: [
      ...
      { name: "Devotional Books", slug: "coffee-table-devotional-book" },
      { name: "Individual Legacy Books", slug: "coffee-table-individual-legacy-book" },
    ]
  },
    { name: "Family Legacy Books", slug: "coffee-table-family-legacy-book" },
    { name: "Business Story Books", slug: "coffee-table-business-story-book" },
