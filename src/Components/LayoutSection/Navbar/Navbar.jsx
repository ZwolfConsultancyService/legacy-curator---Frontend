...
const serviceLinks = [
  { name: "Photo Books",              slug: "photo-book",                    icon: "📷", sub: "Memories, preserved"     },
  { name: "Travel Photo Books",       slug: "travel-photo-book",             icon: "🧳", sub: "Every mile, a memory"   },
  { name: "Wedding Photo Books",      slug: "wedding-photo-book",            icon: "💍", sub: "Your day, forever"      },
  { name: "Individual Photo Books",   slug: "individual-photo-book",         icon: "🖼️", sub: "One life, one story"    },
  { name: "Customized Photo Books",   slug: "customized-photo-book",         icon: "🎨", sub: "Entirely yours"         },
  { name: "Product Catalogue Books",  slug: "product-catalogue-photo-book",  icon: "🛍️", sub: "Products, presented"    },
  { name: "Children's Photo Books",   slug: "childrens-photo-book",          icon: "🧸", sub: "Little moments, big memories" },
  // { name: "Travel Books",       slug: "travel-book",         icon: "✈️", sub: "Journeys, immortalised" },
  // { name: "Legacy Books",       slug: "legacy-book",         icon: "🏛️", sub: "Lineage, honoured"      },
  { name: "Coffee Table Books", slug: "coffee-table",        icon: "☕", sub: "Statement, displayed"   },
  { name: "Memoir Books",       slug: "memoir",              icon: "📖", sub: "Your story, told"       },
  ...
  return (
    <>
      <style>{`
        ...
        .lc-dropdown.portfolio { width: 480px; max-height: 520px; overflow-y: auto; }
        .lc-dropdown.company   { width: 310px; }
        ...
        .drawer-sub.open { max-height: 1600px; }
            ...
            <div className="lc-drop-wrap" ref={dropRef}>
              ...
              <div className={`lc-dropdown portfolio${dropOpen ? " open" : ""}`} role="menu">
                <div className="dd-head">
                  ...
                  <span className="dd-badge">{serviceLinks.length} Book Types</span>
                </div>
                <div className="dd-grid">
                  {serviceLinks.map((svc) => (
                    <Link
