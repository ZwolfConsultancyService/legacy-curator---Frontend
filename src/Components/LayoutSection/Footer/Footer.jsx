...
const socialLinks = [
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/legacycurator.in?igsh=MTBzZWhoOTRsNGY1MA==",
    icon: <InstagramIcon />,
  },
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/legacycurator/", // 👉 apna LinkedIn page/profile link daalo
    icon: <LinkedInIcon />,
  },
];
  ...
  return (
    <footer className="bg-[#FAF7F2]">
      ...
      <div className="bg-[#1B2B24]">
        {" "}
        {/* Thoda aur dark forest variant for contrast */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
            ...
            <div className="flex items-center gap-4 order-1 sm:order-2">
              <Link
                to="/privacy-policy"
                className="text-[11px] text-porcelain/60 hover:text-porcelain transition font-medium"
              >
                Privacy Policy
              </Link>
