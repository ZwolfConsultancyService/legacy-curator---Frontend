    ...
    >
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(255,255,255,0.5)", fontFamily: "'Montserrat', sans-serif" }}>{post.category}</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          <span style={{ fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.15em", color: colors.copper, fontWeight: 600, fontFamily: "'Montserrat', sans-serif" }}>{post.category}</span>
          <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: isMobile ? "1.3rem" : isTablet ? "1.5rem" : "1.75rem", fontWeight: 700, color: "#111", lineHeight: 1.2, marginTop: 12, marginBottom: 16 }}>{post.title}</h2>
          <p style={{ fontSize: isMobile ? "0.82rem" : "0.88rem", lineHeight: 1.8, color: "#666", fontFamily: "'Montserrat', sans-serif", fontWeight: 400 }}>{post.excerpt}</p>
        </div>
  ...
  return (
    ...
    >
      <div style={{ height: 160, background: post.accentBg || "linear-gradient(135deg,#36615A,#2a4a44)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
        <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2.5rem", fontWeight: 700, fontStyle: "italic", color: "rgba(255,255,255,0.1)", userSelect: "none" }}>✦</div>
        <div style={{ position: "absolute", bottom: 14, left: 18 }}>
          <span style={{ fontSize: "0.6rem", textTransform: "uppercase", letterSpacing: "0.14em", color: "rgba(255,255,255,0.55)", border: "1px solid rgba(255,255,255,0.2)", padding: "3px 9px", borderRadius: 2, fontFamily: "'Montserrat', sans-serif" }}>
            {post.category}
          </span>
        </div>
      </div>
      <div style={{ padding: "24px 24px 20px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <div>
          <h3 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1.05rem", fontWeight: 600, color: "#111", lineHeight: 1.35, marginBottom: 12 }}>{post.title}</h3>
          <p style={{ fontSize: "0.8rem", lineHeight: 1.75, color: "#777", fontFamily: "'Montserrat', sans-serif", fontWeight: 400 }}>{post.excerpt}</p>
        </div>
    ...
    <div style={{ backgroundColor: "#ffffff", minHeight: "100vh", fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div style={{ backgroundColor: colors.forest, padding: isMobile ? "44px 20px 36px" : isTablet ? "52px 40px 42px" : "60px 60px 50px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <p style={{ fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(253,255,252,0.5)", marginBottom: 16, fontFamily: "'Montserrat', sans-serif", fontWeight: 500 }}>LegacyCurator · Journal</p>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: isMobile ? 16 : 24 }}>
            <h1 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: isMobile ? "2.4rem" : "clamp(2.8rem, 7vw, 5rem)", fontWeight: 700, color: colors.porcelain, lineHeight: 0.95 }}>
              Stories &<br /><em style={{ fontStyle: "italic", color: "#a8d4cc", fontWeight: 300 }}>Perspectives.</em>
            </h1>
            <p style={{ fontSize: isMobile ? "0.82rem" : "0.88rem", lineHeight: 1.8, color: "rgba(253,255,252,0.55)", maxWidth: isMobile ? "100%" : 340, fontFamily: "'Montserrat', sans-serif", fontWeight: 300 }}>
      ...
      {error && (
        <div style={{ maxWidth: 1200, margin: "24px auto 0", padding: `0 ${px}` }}>
          <div style={{ background: "#fff0f0", border: "1px solid #f5c2c2", borderRadius: 4, padding: "14px 20px", fontSize: "0.84rem", color: "#c0392b", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
            <span>⚠ {error}</span>
            <button onClick={() => fetchBlogs(activeCategory)} style={{ background: "none", border: "none", color: "#c0392b", textDecoration: "underline", cursor: "pointer", fontFamily: "'Montserrat', sans-serif", flexShrink: 0 }}>Retry</button>
          </div>
        </div>
      )}
      ...
      <div className="fade-up" style={{ maxWidth: 1200, margin: "36px auto 0", padding: `0 ${px}` }}>
        {loading && activeCategory === "All" ? (
          ...
          <>
            <div style={{ fontSize: "0.68rem", textTransform: "uppercase", letterSpacing: "0.18em", color: "#bbb", marginBottom: 16, fontFamily: "'Montserrat', sans-serif", fontWeight: 500 }}>✦ Featured Story</div>
      ...
      <section style={{ maxWidth: 1200, margin: "44px auto 0", padding: `0 ${px} ${isMobile ? "52px" : "80px"}` }}>
        {loading ? (
          <>
            <div style={{ fontSize: "0.68rem", textTransform: "uppercase", letterSpacing: "0.18em", color: "#ddd", marginBottom: 28, fontFamily: "'Montserrat', sans-serif" }}>Loading articles…</div>
          ...
          <>
            <div style={{ fontSize: "0.68rem", textTransform: "uppercase", letterSpacing: "0.18em", color: "#bbb", marginBottom: 28, fontFamily: "'Montserrat', sans-serif", fontWeight: 500 }}>
          ...
          <div style={{ textAlign: "center", padding: "80px 0", color: "#bbb" }}>
            <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2rem", marginBottom: 12, opacity: 0.3 }}>✦</div>
            <p style={{ fontSize: "0.85rem", letterSpacing: "0.05em", fontFamily: "'Montserrat', sans-serif" }}>No articles in this category yet.</p>
          </div>
        ) : null}
      </section>
    </div>
