...
// const FOUNDER_IMAGE = founder; // e.g. 'https://your-site.com/photo.jpg'
// // ───────────────────────────────────────────────────────────────────
...
//           letter-spacing: 0.22em; text-transform: uppercase;
//           color: var(--faint); margin-bottom: 40px; padding-bottom: 40px;
...
//           color: #c4956a; line-height: 1.5; margin-bottom: 36px;
//         }
...
//                     {/* Shoulders & body — suit shape */}
//                     <path d="M50 420 C50 300 90 240 130 220 L150 230 L170 220 C210 240 250 300 250 420 Z"
//                       fill="rgba(167,112,61,0.15)" />
//                     <path d="M70 420 C70 310 105 255 135 236 L150 244 L165 236 C195 255 230 310 230 420 Z"
//                       fill="rgba(167,112,61,0.25)" />
//                     {/* Collar / lapels */}
...
//                       fill="rgba(243,240,225,0.12)" letterSpacing="4">FL</text>
//                   </svg>

//                   <span className="fp-initials-bg">FL</span>
//                 </div>
//               )
//             }
...
const storyParas = [
  "Stories of beginnings and setbacks, of families, dreams, sacrifices — pieces of life that never made it into reports, yet mattered the most.",
  "Somewhere between consultations and conversations, her role began to shift. She was no longer just listening to treat — she was listening to remember.",
  "That's when the path changed. From healing with medicine to preserving with meaning. From writing prescriptions to writing legacies.",
  "Today, through Fior Legacy Curator, she works with individuals, families, and founders to shape their journeys into something lasting — books that can be held, shared, and passed on.",
  "Because while health sustains life, it is stories that give it depth — and ensure it is never forgotten.",
];
    ...
    <>
      ...
      <div className="fp-root">
        ...
        <section className="fp-hero">
          <div className="fp-hero-img">
            {FOUNDER_IMAGE
              ? <img src={FOUNDER_IMAGE} alt="Dr. Aishi Sharma" />
              : (
                <div className="fp-hero-img-placeholder">
                  <div className="fp-placeholder-dots" />
                  <div className="fp-bracket fp-bracket-tl" />
          ...
          <div className="fp-hero-right">
            <p className="fp-overline">Fior Legacy Curator</p>
            <p className="fp-founder-name">Dr. Aishi Sharma</p>
            <h1 className="fp-hero-name">
              From<br />
              Medicine<br />
              to <em>Memory.</em>
        ...
        <section className="fp-story">
          ...
          >
            <div className="fp-story-left">
              ...
              <p className="fp-story-sub">
                From healing with medicine to preserving with meaning —
                Dr. Aishi Sharma's journey across two callings.
              </p>
            </div>
