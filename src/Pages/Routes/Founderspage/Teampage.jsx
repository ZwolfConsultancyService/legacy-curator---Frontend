...
//       image: Namrata, 
//       bio: 'Shapes visual storytelling with refined, timeless design, blending heritage with contemporary elegance.' 
//     },
//   ],
// },
//   {
    ...
    members: [
      {
        ...
        role: 'Chief Editor & Creative Director',
        image: sonam,
        bio: 'Sonam Sharma serves as the Chief Editor and Creative Director at Legacy Curators, where she co-shapes the vision of the brand alongside Founder, Dr. Ashish Sharma. At the heart of her role lies a singular intention — to transform lived experiences, generational journeys, and personal histories into narratives that endure beyond time. With a foundation rooted in storytelling, human psychology, and brand strategy, Sonam brings depth, direction, and emotional intelligence to every legacy she helps curate. She leads the narrative architecture of each project, crafting stories that are not only documented but felt — stories that carry the weight of identity, memory, and meaning.',
      },
      {
        initials: 'NC',
        name: 'Namrata Chaudhary',
        role: 'Creative Direction & Design Lead',
        image: Namrata,
        bio: 'Shapes visual storytelling with refined, timeless design, blending heritage with contemporary elegance. Every layout she touches becomes a conversation between the past and the present — turning manuscripts into heirlooms.',
      },
    ],
  },
  {
