...
function Avatar({ member, color, colorPale }) {
  ...
  return (
    <div style={{
      width: '100%', height: '100%', background: colorPale,
      ...
      <div style={{
        ...
        fontSize: 'clamp(56px, 12vw, 88px)', fontWeight: 300,
      ...
      <div style={{
        ...
        textTransform: 'uppercase', color, opacity: .5,
...
/* ── Member Card ──
   KEY FIX: translateY hata diya — sirf opacity fade hai.
   translateY scroll ke saath layout shift karata tha → ruk-ruk feel.
── */
  ...
  return (
    <div
      ...
      style={{
        ...
        opacity: vis ? 1 : 0,
        // ✅ No translateY — scroll ruk-ruk nahi karega
        transition: `opacity 0.5s ${cardIdx * 0.04}s ease`,
        willChange: 'opacity',
      }}
    >
      {/* Photo */}
      ...
      <div style={{
        ...
        <h3 style={{
          ...
          marginBottom: 28, textAlign: 'left', wordBreak: 'break-word',
        }}>
        ...
        <p style={{
          fontFamily: "'Montserrat', sans-serif",
          fontSize: isMobile ? 13 : 14, fontWeight: 300,
          lineHeight: 1.95, color: '#7a7368',
        ...
        <div style={{ marginTop: 32, width: 20, height: 1, background: color, opacity: .4 }} />
      </div>
    </div>
  );
}
...
export default function TeamPage() {
  ...
  // Scroll se active tab auto update
  useEffect(() => {
    const handleScroll = () => {
      for (let i = teams.length - 1; i >= 0; i--) {
        ...
        if (el) {
          ...
          if (top <= TAB_BAR_HEIGHT + 20) {
            setActiveTab(teams[i].id);
            break;
          }
        }
      }
  ...
  // Tab click — offset ke saath smooth scroll
    ...
    <>
      <style>{`
        ...
        .tp-hero {
          ...
          opacity: 0;
          /* ✅ No translateY on hero either */
          transition: opacity .9s .12s ease;
        }
        .tp-hero.v { opacity: 1; }
        ...
        .tp-h1 {
          ...
          letter-spacing: -.04em; color: #1a1714; margin-bottom: 40px;
        }
        ...
        .tp-sl {
          ...
          letter-spacing: .2em; text-transform: uppercase; color: #c4bdb0;
        }
        .tp-hero-r {
        ...
        .tp-body {
          font-size: 16px; font-weight: 300; line-height: 1.95; color: #9a9088;
        }
        .tp-quote {
          font-family: 'Cormorant Garamond', serif;
          font-size: 21px; font-style: italic; font-weight: 300;
          color: #3a3530; line-height: 1.6;
          padding-left: 24px; border-left: 2px solid #A7703D;
        }

        /* ── STICKY TABS — GPU layer, zero jank ── */
        .tp-tabs-wrap {
        ...
        .tp-tab {
          ...
          color: #c4bdb0; padding: 20px 0; margin-right: 36px;
          ...
          scroll-snap-align: start; outline: none; user-select: none;
        }
        ...
        .tp-tab.on .tp-pip { transform: scale(1.4); }
        ...
        .tp-sec-l {
          padding: 72px 0 72px 60px; border-right: 1px solid #e8e2d4;
        ...
        .tp-sec-r {
          padding: 72px 60px; display: flex;
        ...
        .tp-sdesc {
          ...
          line-height: 1.9; color: #9a9088; max-width: 500px;
        }

        /* TABLET */
        @media (max-width: 1024px) {
          .tp-hero { padding: 80px 40px; gap: 52px; }
        ...
        @media (max-width: 640px) {
          .tp-hero {
            grid-template-columns: 1fr; padding: 60px 20px 64px;
          ...
          .tp-sec-l {
            padding: 40px 20px 28px; border-right: none;
            border-bottom: 1px solid #e8e2d4;
