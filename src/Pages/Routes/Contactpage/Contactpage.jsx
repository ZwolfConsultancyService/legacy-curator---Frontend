    ...
    <div style={{ backgroundColor: "#ffffff", minHeight: "100vh", fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="hero-band">
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <p style={{
            ...
            color: "rgba(253,255,252,0.5)", marginBottom: 16,
      ...
      <div className="contact-wrap">
        ...
        <div className="fade-up">
          <p style={{
            fontSize: "0.92rem", lineHeight: 1.85, color: "#666",
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: colors.porcelain, fontSize: "1rem", flexShrink: 0,
            }}>
              ◎
            </div>
            <div>
        ...
        <div className="fade-up" style={{ animationDelay: "0.12s" }}>
          {sent ? (
            <div style={{ textAlign: "center", padding: "clamp(40px, 8vw, 80px) 24px" }}>
              ...
              <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "clamp(1.4rem, 4vw, 2rem)", fontWeight: 700, color: "#111", marginBottom: 16 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "transparent", border: `1px solid ${colors.forest}`,
                  color: colors.forest, fontSize: "0.78rem",
            ...
            <div className="form-box">
              <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "clamp(1.3rem, 4vw, 1.75rem)", fontWeight: 700, color: "#111", marginBottom: 8 }}>
                Send a <em style={{ fontStyle: "italic", color: colors.copper, fontWeight: 300 }}>message</em>
              </h2>
              <p style={{ fontSize: "0.78rem", color: "#aaa", marginBottom: 36, letterSpacing: "0.03em", fontFamily: "'Montserrat', sans-serif" }}>
              ...
              {error && (
                <div style={{
                  ...
                  borderRadius: 3, fontSize: "0.82rem", color: "#c0392b",
                  fontFamily: "'Montserrat', sans-serif",
                }}>
                  ⚠ {error}
                </div>
              ...
              <button
                ...
                style={{
                  ...
                  color: colors.porcelain, border: "none", borderRadius: 2,
                  fontSize: "0.8rem", fontWeight: 600, letterSpacing: "0.12em",
                  textTransform: "uppercase",
                  cursor: loading ? "not-allowed" : "pointer",
                  fontFamily: "'Montserrat', sans-serif",
                  transition: "background 0.3s", opacity: loading ? 0.8 : 1,
                }}
